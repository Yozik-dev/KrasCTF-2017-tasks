...
var _Stat0s$project$Model_Geometry$distance = F2(
	function (_p1, _p0) {
		var _p2 = _p1;
		var _p3 = _p0;
		return _elm_lang$core$Basics$sqrt(
			Math.pow(_p3._0 - _p2._0, 2) + Math.pow(_p3._1 - _p2._1, 2));
	});
var _Stat0s$project$Model_Geometry$Vector = F2(
	function (a, b) {
		return {x: a, y: b};
	});

var _Stat0s$project$Model_Scene$starRadius = 3;
var _Stat0s$project$Model_Scene$playerRadius = 10;
var _Stat0s$project$Model_Scene$createStar = {
	position: {x: 200, y: 200}
};
var _Stat0s$project$Model_Scene$createPlayer = F4(
	function (leftKey, rightKey, upKey, downKey) {
		return {
			score: 0,
			leftKey: _elm_lang$core$Char$toCode(leftKey),
			rightKey: _elm_lang$core$Char$toCode(rightKey),
			upKey: _elm_lang$core$Char$toCode(upKey),
			downKey: _elm_lang$core$Char$toCode(downKey),
			position: {x: 100, y: 100},
			velocity: {x: 0, y: 0}
		};
	});
var _Stat0s$project$Model_Scene$initialScene = {
	player: A4(
		_Stat0s$project$Model_Scene$createPlayer,
		_elm_lang$core$Native_Utils.chr('A'),
		_elm_lang$core$Native_Utils.chr('D'),
		_elm_lang$core$Native_Utils.chr('W'),
		_elm_lang$core$Native_Utils.chr('S')),
	star: _Stat0s$project$Model_Scene$createStar,
	enemies: {ctor: '[]'}
};
var _Stat0s$project$Model_Scene$Scene = F3(
	function (a, b, c) {
		return {player: a, star: b, enemies: c};
	});
var _Stat0s$project$Model_Scene$Player = F7(
	function (a, b, c, d, e, f, g) {
		return {score: a, leftKey: b, rightKey: c, upKey: d, downKey: e, position: f, velocity: g};
	});
var _Stat0s$project$Model_Scene$Star = function (a) {
	return {position: a};
};
var _Stat0s$project$Model_Scene$Enemy = F2(
	function (a, b) {
		return {x: a, y: b};
	});

var _Stat0s$project$Model_Ui$keyPressed = F2(
	function (keycode, pressedKeys) {
		return A2(_elm_lang$core$Set$member, keycode, pressedKeys);
	});
var _Stat0s$project$Model_Ui$Ui = F4(
	function (a, b, c, d) {
		return {windowSize: a, pressedKeys: b, screen: c, winMessage: d};
	});
var _Stat0s$project$Model_Ui$WinScreen = {ctor: 'WinScreen'};
var _Stat0s$project$Model_Ui$PlayScreen = {ctor: 'PlayScreen'};
var _Stat0s$project$Model_Ui$StartScreen = {ctor: 'StartScreen'};
var _Stat0s$project$Model_Ui$initialUi = {
	windowSize: {ctor: '_Tuple2', _0: 600, _1: 400},
	pressedKeys: _elm_lang$core$Set$empty,
	screen: _Stat0s$project$Model_Ui$StartScreen,
	winMessage: ''
};

var _Stat0s$project$Model$initialModel = {ui: _Stat0s$project$Model_Ui$initialUi, scene: _Stat0s$project$Model_Scene$initialScene, secondsPassed: 0, urlListen: 'ws://193.218.139.202:1337', urlSend: 'ws://193.218.139.202:1337', gameTime: 0, salt: 'sdl4Df4(dsk!3sk*3saKha13SHA@fsl#'};
var _Stat0s$project$Model$freshGame = function (ui) {
	var ui_ = _elm_lang$core$Native_Utils.update(
		ui,
		{screen: _Stat0s$project$Model_Ui$PlayScreen, pressedKeys: _elm_lang$core$Set$empty});
	return _elm_lang$core$Native_Utils.update(
		_Stat0s$project$Model$initialModel,
		{ui: ui_});
};
var _Stat0s$project$Model$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {ui: a, scene: b, secondsPassed: c, urlListen: d, urlSend: e, gameTime: f, salt: g};
	});
...
var _Stat0s$project$Subscription$NoOp = {ctor: 'NoOp'};
var _Stat0s$project$Subscription$SocketMessage = function (a) {
	return {ctor: 'SocketMessage', _0: a};
};
var _Stat0s$project$Subscription$TimeSecond = function (a) {
	return {ctor: 'TimeSecond', _0: a};
};
var _Stat0s$project$Subscription$StartGame = {ctor: 'StartGame'};
var _Stat0s$project$Subscription$KeyChange = F2(
	function (a, b) {
		return {ctor: 'KeyChange', _0: a, _1: b};
	});
var _Stat0s$project$Subscription$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _Stat0s$project$Subscription$subscriptions = function (model) {
	var socket = A2(_elm_lang$websocket$WebSocket$listen, model.urlListen, _Stat0s$project$Subscription$SocketMessage);
	var seconds = A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second, _Stat0s$project$Subscription$TimeSecond);
	var animation = {
		ctor: '::',
		_0: _elm_lang$animation_frame$AnimationFrame$diffs(_Stat0s$project$Subscription$Tick),
		_1: {ctor: '[]'}
	};
	var keys = {
		ctor: '::',
		_0: _elm_lang$keyboard$Keyboard$downs(
			_Stat0s$project$Subscription$KeyChange(true)),
		_1: {
			ctor: '::',
			_0: _elm_lang$keyboard$Keyboard$ups(
				_Stat0s$project$Subscription$KeyChange(false)),
			_1: {ctor: '[]'}
		}
	};
	var _p0 = model.ui.screen;
	switch (_p0.ctor) {
		case 'StartScreen':
...
var _billstclair$elm_sha256$Sha256$initialHs = function (is224) {
	return is224 ? {a: -1056596264, b: 914150663, c: 812702999, d: -150054599, e: -4191439, f: 1750603025, g: 1694076839, h: -1090891868} : {a: 1779033703, b: -1150833019, c: 1013904242, d: -1521486534, e: 1359893119, f: -1694144372, g: 528734635, h: 1541459225};
};
...
var _Stat0s$project$Util$enemyDecoder = A3(
	_elm_lang$core$Json_Decode$map2,
	_Stat0s$project$Model_Scene$Enemy,
...
var _Stat0s$project$Util$vectorDecoder = A3(
	_elm_lang$core$Json_Decode$map2,
	_Stat0s$project$Model_Geometry$Vector,
	A2(_elm_lang$core$Json_Decode$field, 'x', _elm_lang$core$Json_Decode$float),
	A2(_elm_lang$core$Json_Decode$field, 'y', _elm_lang$core$Json_Decode$float));
var _Stat0s$project$Util$getEnemies = function (message) {
	return A2(
		...
		A2(
			...
			A2(
				...
				'coords',
				_elm_lang$core$Json_Decode$list(_Stat0s$project$Util$enemyDecoder)),
			message));
};
var _Stat0s$project$Util$getStarPosition = function (message) {
	return A2(
		_elm_lang$core$Result$withDefault,
		A2(_Stat0s$project$Model_Geometry$Vector, 0, 0),
		A2(_elm_lang$core$Json_Decode$decodeString, _Stat0s$project$Util$vectorDecoder, message));
};
var _Stat0s$project$Util$stringDecoder = F2(
	function (field_, message_) {
		return A2(
			_elm_lang$core$Json_Decode$decodeString,
			A2(_elm_lang$core$Json_Decode$field, field_, _elm_lang$core$Json_Decode$string),
			message_);
	});
var _Stat0s$project$Util$moveMessage = function (model) {
	var mes_ = _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
			...
			_1: {
				...
				_0: {
					...
					_1: _elm_lang$core$Json_Encode$string(
						_elm_lang$core$Basics$toString(model.scene.player.position.x))
				},
				_1: {
					ctor: '::',
					_0: {
						...
						_0: 'y',
						_1: _elm_lang$core$Json_Encode$string(
							_elm_lang$core$Basics$toString(model.scene.player.position.y))
					},
					_1: {ctor: '[]'}
				}
			}
		});
	return A2(_elm_lang$core$Json_Encode$encode, 0, mes_);
};
var _Stat0s$project$Util$eatStarMessage = function (model) {
	var t_ = model.gameTime;
	var message_ = 'star_eat';
	var sha = _billstclair$elm_sha256$Sha256$sha256(
		A2(
			_elm_lang$core$Basics_ops['++'],
			message_,
			A2(
				_elm_lang$core$Basics_ops['++'],
				_elm_lang$core$Basics$toString(model.scene.player.score),
				A2(
					_elm_lang$core$Basics_ops['++'],
					_elm_lang$core$Basics$toString(t_),
					model.salt))));
	var mes_ = _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'm',
				_1: _elm_lang$core$Json_Encode$string(message_)
			},
			_1: {
				ctor: '::',
				_0: {
				...
				_1: {
					...
					_1: {
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'hash',
							_1: _elm_lang$core$Json_Encode$string(sha)
						},
						_1: {ctor: '[]'}
					}
				}
...
var _Stat0s$project$Update$freshKeyPress = F3(
	function (keycode, previouslyPressedKeys, currentlyPressedKeys) {
		var pressed = _Stat0s$project$Model_Ui$keyPressed(keycode);
		return pressed(currentlyPressedKeys) && (!pressed(previouslyPressedKeys));
	});
var _Stat0s$project$Update$handleKeyChange = F3(
	function (pressed, keycode, _p0) {
		var _p1 = _p0;
		var _p4 = _p1.ui;
		var _p3 = _p1;
		var fn = pressed ? _elm_lang$core$Set$insert : _elm_lang$core$Set$remove;
		var pressedKeys_ = A2(fn, keycode, _p4.pressedKeys);
		var _p2 = _p4.screen;
		if (_p2.ctor === 'PlayScreen') {
			var justPressed = function (keycode) {
				return A3(_Stat0s$project$Update$freshKeyPress, keycode, _p4.pressedKeys, pressedKeys_);
			};
			var ui_ = _elm_lang$core$Native_Utils.update(
				_p4,
...
var _Stat0s$project$Update$friction = F2(
	function (delta, vx) {
		return vx / (1 + (1.8e-3 * delta));
	});
var _Stat0s$project$Update$steerAndGravity = F3(
	function (delta, _p6, _p5) {
		var _p7 = _p6;
		var _p11 = _p7.pressedKeys;
		var _p8 = _p5;
		var _p10 = _p8.velocity;
		var _p9 = _p8;
		var directionY = A2(_Stat0s$project$Model_Ui$keyPressed, _p9.upKey, _p11) ? -1 : (A2(_Stat0s$project$Model_Ui$keyPressed, _p9.downKey, _p11) ? 1 : 0);
		var ay = directionY * 1.0e-4;
		var vy_ = A2(_Stat0s$project$Update$friction, delta, _p10.y + (ay * delta));
		var directionX = A2(_Stat0s$project$Model_Ui$keyPressed, _p9.leftKey, _p11) ? -1 : (A2(_Stat0s$project$Model_Ui$keyPressed, _p9.rightKey, _p11) ? 1 : 0);
		var ax = directionX * 1.0e-4;
		var vx_ = A2(_Stat0s$project$Update$friction, delta, _p10.x + (ax * delta));
...
var _Stat0s$project$Update$blockWall = F2(
	function (_p12, p) {
		var _p13 = _p12;
		var h_ = _elm_lang$core$Basics$toFloat(_p13._1);
		var y_ = (_elm_lang$core$Native_Utils.cmp(p.position.y, h_) > 0) ? h_ : ((_elm_lang$core$Native_Utils.cmp(p.position.y, 0) < 0) ? 0 : p.position.y);
		var vy_ = (_elm_lang$core$Native_Utils.cmp(p.position.y, h_) > 0) ? 0 : ((_elm_lang$core$Native_Utils.cmp(p.position.y, 0) < 0) ? 0 : p.velocity.y);
		var w_ = _elm_lang$core$Basics$toFloat(_p13._0);
		var x_ = (_elm_lang$core$Native_Utils.cmp(p.position.x, w_) > 0) ? w_ : ((_elm_lang$core$Native_Utils.cmp(p.position.x, 0) < 0) ? 0 : p.position.x);
		var pos_ = {x: x_, y: y_};
		var vx_ = (_elm_lang$core$Native_Utils.cmp(p.position.x, w_) > 0) ? 0 : ((_elm_lang$core$Native_Utils.cmp(p.position.x, 0) < 0) ? 0 : p.velocity.x);
		var vel_ = {x: vx_, y: vy_};
		return _elm_lang$core$Native_Utils.update(
			p,
			{position: pos_, velocity: vel_});
	});
var _Stat0s$project$Update$walk = F2(
	function (delta, p) {
		var y_ = p.position.y + (p.velocity.y * delta);
		var x_ = p.position.x + (p.velocity.x * delta);
		var pos_ = {x: x_, y: y_};
		return _elm_lang$core$Native_Utils.update(
			p,
			{position: pos_});
	});
var _Stat0s$project$Update$movePlayer = F3(
	function (delta, _p14, player) {
		var _p15 = _p14;
		return A2(
			_Stat0s$project$Update$blockWall,
			_p15.windowSize,
			A2(_Stat0s$project$Update$walk, delta, player));
	});
var _Stat0s$project$Update$updateStar = F2(
	function (star, vec) {
		return _elm_lang$core$Native_Utils.update(
			star,
			{position: vec});
	});
var _Stat0s$project$Update$addScore = F2(
	function (p, isEat) {
		return _elm_lang$core$Native_Utils.update(
			p,
			{
				score: isEat ? (p.score + 1) : p.score
			});
	});
var _Stat0s$project$Update$getStar = F3(
	function (p, _p16, star) {
		var _p17 = _p16;
		var d = A2(
			_Stat0s$project$Model_Geometry$distance,
			{ctor: '_Tuple2', _0: p.position.x, _1: p.position.y},
			{ctor: '_Tuple2', _0: star.position.x, _1: star.position.y});
		return (_elm_lang$core$Native_Utils.cmp(d, _Stat0s$project$Model_Scene$starRadius + _Stat0s$project$Model_Scene$playerRadius) < 0) ? {
			ctor: '_Tuple2',
			_0: true,
			_1: A2(
				_Stat0s$project$Update$updateStar,
				star,
				A2(_Stat0s$project$Model_Geometry$Vector, 1000, 1000))
		} : {ctor: '_Tuple2', _0: false, _1: star};
	});
var _Stat0s$project$Update$update = F2(
	function (action, _p18) {
		var _p19 = _p18;
		var _p27 = _p19.ui;
		var _p26 = _p19.scene;
		var _p25 = _p19;
		...
		switch (_p20.ctor) {
			case 'Tick':
				var _p22 = _p20._0;
				var gameTime_ = _p25.gameTime + (_p22 * 1);
				var player_ = A3(
					_Stat0s$project$Update$movePlayer,
					_p22,
					_p27,
					A3(_Stat0s$project$Update$steerAndGravity, _p22, _p27, _p26.player));
				var _p21 = A3(_Stat0s$project$Update$getStar, player_, _p27, _p26.star);
				var isEat = _p21._0;
				var star__ = _p21._1;
				var cmd = isEat ? A2(
					_elm_lang$websocket$WebSocket$send,
					_p25.urlSend,
					_Stat0s$project$Util$eatStarMessage(_p25)) : _elm_lang$core$Platform_Cmd$none;
				var player__ = A2(_Stat0s$project$Update$addScore, player_, isEat);
				var scene_ = _elm_lang$core$Native_Utils.update(
					_p26,
					{player: player__, star: star__});
				var model_ = _elm_lang$core$Native_Utils.update(
					_p25,
					{scene: scene_, gameTime: gameTime_});
				return {
					ctor: '_Tuple2',
					_0: model_,
					_1: _elm_lang$core$Platform_Cmd$batch(
						{
							...
							_1: {
								...
								_0: A2(
									_elm_lang$websocket$WebSocket$send,
									_p25.urlSend,
									_Stat0s$project$Util$moveMessage(model_)),
								_1: {ctor: '[]'}
							}
						})
				};
			case 'KeyChange':
				return {
					ctor: '_Tuple2',
					_0: A3(_Stat0s$project$Update$handleKeyChange, _p20._0, _p20._1, _p25),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'StartGame':
				return {
					ctor: '_Tuple2',
					_0: _Stat0s$project$Model$freshGame(_p27),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'TimeSecond':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						_p25,
						{secondsPassed: _p25.secondsPassed + 1}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'SocketMessage':
				var _p24 = _p20._0;
				var mes_action = A2(_Stat0s$project$Util$stringDecoder, 'm', _p24);
				var _p23 = mes_action;
				_v9_3:
				do {
					if (_p23.ctor === 'Ok') {
						switch (_p23._0) {
							case 'new_star':
								var star_ = A2(
									_Stat0s$project$Update$updateStar,
									_p26.star,
									_Stat0s$project$Util$getStarPosition(_p24));
								var scene_ = _elm_lang$core$Native_Utils.update(
									_p26,
									{star: star_});
								return {
							...
							case 'win':
								var flag_ = A2(
									...
									_elm_lang$core$Result$toMaybe(
										A2(_Stat0s$project$Util$stringDecoder, 'flag', _p24)));
								var ui_ = _elm_lang$core$Native_Utils.update(
									_p27,
									{winMessage: flag_, screen: _Stat0s$project$Model_Ui$WinScreen});
								return {
									ctor: '_Tuple2',
									_0: _elm_lang$core$Native_Utils.update(
										_p25,
							...
							case 'players':
								var enemies_ = _Stat0s$project$Util$getEnemies(_p24);
								var scene_ = _elm_lang$core$Native_Utils.update(
									_p26,
									{enemies: enemies_});
								return {
...
var _Stat0s$project$View$renderTextLine = F6(
	function (xPos, yPos, fontSize, anchor, content, extraAttrs) {
		var attributes = A2(
			_elm_lang$core$List$append,
			extraAttrs,
			{
				...
				_1: {
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$fontFamily('Courier New, Courier, Monaco, monospace'),
							_1: {
								ctor: '::',
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$fill('rgba(255,255,255,.8)'),
									_1: {ctor: '[]'}
								}
							}
						}
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$svg$Svg$text(content),
				_1: {ctor: '[]'}
			});
	});
var _Stat0s$project$View$renderTextParagraph = F6(
	function (xPos, yPos, fontSize, anchor, lines, extraAttrs) {
		return A2(
			_elm_lang$svg$Svg$g,
			{ctor: '[]'},
			A2(
				...
				F2(
					function (index, line) {
						return A6(_Stat0s$project$View$renderTextLine, xPos, yPos + ((((index * fontSize) * 5) / 4) | 0), fontSize, anchor, line, extraAttrs);
					}),
				lines));
	});
var _Stat0s$project$View$normalFontSize = F2(
	function (w, h) {
		return A2(
			_elm_lang$core$Basics$min,
			24,
			(A2(_elm_lang$core$Basics$min, w, h) / 20) | 0);
	});
var _Stat0s$project$View$largeText = F4(
	function (w, h, y, str) {
		return A6(
			_Stat0s$project$View$renderTextLine,
			(w / 2) | 0,
			y,
			A2(_Stat0s$project$View$normalFontSize, w, h) * 2,
			'middle',
			str,
			{ctor: '[]'});
	});
var _Stat0s$project$View$smallText = F4(
	function (w, h, y, str) {
		return A6(
			_Stat0s$project$View$renderTextLine,
			(w / 2) | 0,
			y,
			A2(_Stat0s$project$View$normalFontSize, w, h),
			'middle',
			str,
			{ctor: '[]'});
	});
var _Stat0s$project$View$renderEnemy = function (enemy) {
	return A2(
		_elm_lang$svg$Svg$circle,
		{
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$cx(
				_elm_lang$core$Basics$toString(enemy.x)),
			_1: {
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$cy(
					_elm_lang$core$Basics$toString(enemy.y)),
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$r(
						_elm_lang$core$Basics$toString(_Stat0s$project$Model_Scene$playerRadius)),
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$fill('rgba(0,0,255,.5)'),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _Stat0s$project$View$renderEnemies = function (enemies) {
	return A2(_elm_lang$core$List$map, _Stat0s$project$View$renderEnemy, enemies);
};
var _Stat0s$project$View$renderStar = function (_p0) {
	var _p1 = _p0;
		...
		_elm_lang$svg$Svg$circle,
		{
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$r(
						_elm_lang$core$Basics$toString(_Stat0s$project$Model_Scene$starRadius)),
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$fill('rgba(255,255,0,.9)'),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _Stat0s$project$View$renderPlayer = function (_p3) {
	var _p4 = _p3;
		...
		_elm_lang$svg$Svg$circle,
		{
			...
			_1: {
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$fill('rgba(255,0,0,.8)'),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _Stat0s$project$View$renderWall = function (_p6) {
	var _p7 = _p6;
	return A2(
			...
			_1: {
				...
				_1: {
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$fill('rgba(255,255,255,.5)'),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _Stat0s$project$View$svgAttributes = function (_p8) {
	var _p9 = _p8;
	var _p11 = _p9._0;
	var _p10 = _p9._1;
	return {
			...
			_1: {
				...
				_1: {
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$style('position: fixed; cursor: none;'),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _Stat0s$project$View$renderPlayScreen = F3(
	function (windowSize, scene, ui) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('game-box'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					_Stat0s$project$View$svgAttributes(windowSize),
					A2(
						_elm_lang$core$Basics_ops['++'],
						{
							ctor: '::',
							_0: _Stat0s$project$View$renderWall(windowSize),
							_1: {
								ctor: '::',
								_0: _Stat0s$project$View$renderPlayer(scene.player),
								_1: {
									ctor: '::',
									_0: _Stat0s$project$View$renderStar(scene.star),
									_1: {ctor: '[]'}
								}
							}
						},
						_Stat0s$project$View$renderEnemies(scene.enemies))),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$div,
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('score-text'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(
								_elm_lang$core$Basics$toString(scene.player.score)),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _Stat0s$project$View$renderStartScreen = F2(
	function (_p12, secondsPassed) {
		var _p13 = _p12;
		var _p15 = _p13._0;
		var _p14 = _p13._1;
		var authorLink = A6(
			...
			(_p15 / 2) | 0,
			((_p14 * 7) / 8) | 0,
			A2(_Stat0s$project$View$normalFontSize, _p15, _p14),
			'middle',
			'Created by Statos',
			{ctor: '[]'});
		var paragraph = F2(
			function (y, lines) {
				return A6(
					_Stat0s$project$View$renderTextParagraph,
					(_p15 / 2) | 0,
					y,
					A2(_Stat0s$project$View$normalFontSize, _p15, _p14),
					'middle',
		...
		var goal = A2(
			...
			{
				ctor: '::',
				_0: 'Get points for pushing',
				_1: {
					ctor: '::',
					_0: 'the other off the edge',
					_1: {ctor: '[]'}
				}
			});
		var win = A2(
			...
			{
				ctor: '::',
				_0: 'Score 1000 points to win!',
				_1: {ctor: '[]'}
			});
		var hardwareWarning1 = A2(
			paragraph,
			((_p14 * 9) / 20) | 0,
			{
				ctor: '::',
				_0: 'You need a keyboard',
				_1: {ctor: '[]'}
			});
		var hardwareWarning2 = A2(
			paragraph,
			((_p14 * 10) / 20) | 0,
			{
				ctor: '::',
				_0: 'to play this game :(',
				_1: {ctor: '[]'}
			});
		var clickToStart = A4(_Stat0s$project$View$smallText, _p15, _p14, ((_p14 * 6) / 8) | 0, 'Click to start');
		var title = A4(_Stat0s$project$View$largeText, _p15, _p14, (_p14 / 5) | 0, 'Stone hunter');
		var children = (_elm_lang$core$Native_Utils.cmp(_p15, 600) < 0) ? {
			ctor: '::',
			_0: title,
			_1: {
				ctor: '::',
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				(_elm_lang$core$Native_Utils.cmp(secondsPassed, 1) > -1) ? {
					ctor: '::',
					_0: keys,
					_1: {
						ctor: '::',
				...
				((_elm_lang$core$Native_Utils.cmp(secondsPassed, 3) > -1) && _elm_lang$core$Native_Utils.eq(
					A2(_elm_lang$core$Basics_ops['%'], secondsPassed, 2),
					1)) ? {
					ctor: '::',
					_0: clickToStart,
					_1: {ctor: '[]'}
				} : {ctor: '[]'}));
		var clickHandler = _elm_lang$svg$Svg_Events$onClick(_Stat0s$project$Subscription$StartGame);
		var screenAttrs = A2(
			_elm_lang$core$Basics_ops['++'],
			{
				ctor: '::',
			...
			_Stat0s$project$View$svgAttributes(
				{ctor: '_Tuple2', _0: _p15, _1: _p14}));
		return A2(_elm_lang$svg$Svg$svg, screenAttrs, children);
	});
var _Stat0s$project$View$view = function (_p16) {
	var _p17 = _p16;
	var _p19 = _p17.ui;
	var _p18 = _p19.screen;
	switch (_p18.ctor) {
		case 'StartScreen':
			return A2(_Stat0s$project$View$renderStartScreen, _p19.windowSize, _p17.secondsPassed);
		case 'PlayScreen':
			return A3(_Stat0s$project$View$renderPlayScreen, _p19.windowSize, _p17.scene, _p19);
		default:
			return A2(
				_elm_lang$html$Html$div,
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('win-message'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(_p19.winMessage),
					_1: {ctor: '[]'}
				});
	}
};

var _Stat0s$project$Main$main = _elm_lang$html$Html$program(
	{
		init: {ctor: '_Tuple2', _0: _Stat0s$project$Model$initialModel, _1: _elm_lang$core$Platform_Cmd$none},
		update: _Stat0s$project$Update$update,
		view: _Stat0s$project$View$view,
		subscriptions: _Stat0s$project$Subscription$subscriptions
	})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _Stat0s$project$Main$main !== 'undefined') {
    _Stat0s$project$Main$main(Elm['Main'], 'Main', undefined);
}
Elm['Model'] = Elm['Model'] || {};
if (typeof _Stat0s$project$Model$main !== 'undefined') {
    _Stat0s$project$Model$main(Elm['Model'], 'Model', undefined);
}
Elm['Model'] = Elm['Model'] || {};
Elm['Model']['Geometry'] = Elm['Model']['Geometry'] || {};
if (typeof _Stat0s$project$Model_Geometry$main !== 'undefined') {
    _Stat0s$project$Model_Geometry$main(Elm['Model']['Geometry'], 'Model.Geometry', undefined);
}
Elm['Model'] = Elm['Model'] || {};
Elm['Model']['Scene'] = Elm['Model']['Scene'] || {};
if (typeof _Stat0s$project$Model_Scene$main !== 'undefined') {
    _Stat0s$project$Model_Scene$main(Elm['Model']['Scene'], 'Model.Scene', undefined);
}
Elm['Model'] = Elm['Model'] || {};
Elm['Model']['Ui'] = Elm['Model']['Ui'] || {};
if (typeof _Stat0s$project$Model_Ui$main !== 'undefined') {
    _Stat0s$project$Model_Ui$main(Elm['Model']['Ui'], 'Model.Ui', undefined);
}
Elm['Subscription'] = Elm['Subscription'] || {};
if (typeof _Stat0s$project$Subscription$main !== 'undefined') {
    _Stat0s$project$Subscription$main(Elm['Subscription'], 'Subscription', undefined);
}
Elm['Update'] = Elm['Update'] || {};
if (typeof _Stat0s$project$Update$main !== 'undefined') {
    _Stat0s$project$Update$main(Elm['Update'], 'Update', undefined);
}
Elm['Util'] = Elm['Util'] || {};
if (typeof _Stat0s$project$Util$main !== 'undefined') {
    _Stat0s$project$Util$main(Elm['Util'], 'Util', undefined);
}
Elm['View'] = Elm['View'] || {};
if (typeof _Stat0s$project$View$main !== 'undefined') {
    _Stat0s$project$View$main(Elm['View'], 'View', undefined);
}
